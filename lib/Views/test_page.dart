...
class _TestPageState extends State<TestPage>
    ...
    if (testName.contains("Beck")) {
      return [
        ...
        Question("3. Past Failure", [
          ...
          "I feel I have failed more than most people",
        ...
        Question("4. Loss of Pleasure", [
          "I get as much pleasure as I used to",
          "I do not enjoy things as much",
        ...
        Question("5. Guilty Feelings", [
          ...
          "I feel guilty over many things",
        ...
        Question("9. Suicidal Thoughts", [
          ...
          "I have thoughts of killing myself but wouldn’t carry them out",
        ...
        Question("11. Agitation", [
          ...
          "I am so restless it is hard to stay still",
          "I am so restless I have to be moving constantly"
        ], [
          0,
          1,
          2,
        ...
        Question("12. Loss of Interest", [
          ...
          "I have lost all interest in other people"
        ], [
          0,
          1,
          2,
        ...
        Question("13. Indecisiveness", [
          "I make decisions as well as before",
        ...
        Question("14. Worthlessness", [
          ...
          "I don’t consider myself as worthwhile as before",
        ...
        Question("15. Loss of Energy", [
          "I have as much energy as before",
        ...
        Question("20. Tiredness or Fatigue", [
          ...
          "I am too tired to do many of my usual activities",
          "I am too tired to do most things"
        ], [
          0,
          1,
          2,
      ...
      return [
        ...
        Question("4. Dealt successfully with irritating life hassles?", [
          "Never",
          "Almost never",
          "Sometimes",
          "Fairly often",
        ...
        Question(
            "5. Felt that you were effectively coping with important changes?",
            [
              "Never",
              "Almost never",
              "Sometimes",
        ...
        Question("7. Felt that things were going your way?", [
          "Never",
          "Almost never",
          "Sometimes",
          "Fairly often",
        ...
        Question("9. Been able to control irritations in your life?", [
          "Never",
          "Almost never",
          "Sometimes",
          "Fairly often",
        ...
        Question("10. Felt that you were on top of things?", [
          "Never",
          "Almost never",
          "Sometimes",
          "Fairly often",
      ...
      return [
        ...
        Question(
            ...
            [0, 1, 2, 3]),
        Question(
            "7. Overall, I feel that I am a failure.",
            ["Strongly disagree", "Disagree", "Agree", "Strongly agree"],
            [3, 2, 1, 0]),
        Question(
            "8. I feel that I’m a person of worth.",
            ["Strongly disagree", "Disagree", "Agree", "Strongly agree"],
            [0, 1, 2, 3]),
        Question(
      ...
      return [
        Question("1. Able to adapt to change", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("2. Can deal with whatever comes", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("3. Try to see the humorous side of things", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("4. Coping with stress strengthens me", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("5. Tend to bounce back after illness or hardship", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("6. Can achieve goals despite obstacles", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("7. Can stay focused under pressure", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("8. Not easily discouraged by failure", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("9. Think of self as strong person", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
        ...
        Question("10. Make unpopular or difficult decisions", [
          "Not true at all",
          "Rarely true",
          "Sometimes true",
          "Often true",
  ...
  void _showResultPage() async {
    ...
    if (widget.testName.contains("Beck")) {
      ...
      if (totalScore >= 26)
        resultText = "High self-esteem";
      else if (totalScore >= 15)
        resultText = "Normal self-esteem";
      else
        resultText = "Low self-esteem";
    } else if (widget.testName.contains("Resilience")) {
      if (totalScore >= 30)
        resultText = "High resilience";
      else if (totalScore >= 20)
        resultText = "Moderate resilience";
      else
        resultText = "Low resilience";
    }

    // Save test result to Firebase
    await _saveTestResultToFirebase(resultText);
  ...
  Future<void> _saveTestResultToFirebase(String resultText) async {
    try {
